    ...
    public void tampil(){        
        try{   
            ...
            ps=koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as nm_penyakit from diagnosa_pasien inner join penyakit "+
                    ...
                    "where diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1' and reg_periksa.tgl_registrasi between ? and ? and diagnosa_pasien.kd_penyakit IN "+
    ...
    public void tampil2(){        
        try{   
            ...
            ps3=koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as nm_penyakit from diagnosa_pasien inner join penyakit "+
                    ...
                    "kamar_inap.tgl_keluar between ? and ? and diagnosa_pasien.kd_penyakit IN "+
                    "('A09','A06','A01','A15','A16','Z03','A35','K75.9','O98.4','B15.9','B16.9','B54','B51','B50','A91','A90','J18','P23.9','J06.9','G04.9','G03.9','I20.9','I21.9','I10','I11','I12','I13','I15','E10','E11','E12','E14','C53','C50','C34','S06','F29.9') "+
                    "group by diagnosa_pasien.kd_penyakit ");
            try {
