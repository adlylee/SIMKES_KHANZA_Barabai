...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKonsul.setText("Jawaban Konsul");
        BtnKonsul.setFocusPainted(false);
        BtnKonsul.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKonsul.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKonsul.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKonsul.setName("BtnKonsul"); // NOI18N
        BtnKonsul.setPreferredSize(new java.awt.Dimension(120, 23));
        BtnKonsul.setRoundRect(false);
        BtnKonsul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonsulActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKonsul);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgJawabKonsul konsul=new DlgJawabKonsul(null,true);
            konsul.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            konsul.setLocationRelativeTo(internalFrame1);
            konsul.setDataPasien(TNoRw.getText(), TNoRM.getText(), TPasien.getText(), KdDok.getText(),TDokter.getText(),Sequel.cariIsi("select poliklinik.nm_poli from rujukan_internal_poli, poliklinik where rujukan_internal_poli.kd_poli = poliklinik.kd_poli AND no_rawat = '"+TNoRw.getText()+"'"),Sequel.cariIsi("select konsul from rujukan_internal_poli_detail where no_rawat= '"+TNoRw.getText().toString()+"'"));
